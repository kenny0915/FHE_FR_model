...
- `docs/upstream/arcface.md`: original ArcFace notes, including dataset download links.
...
Download the required face datasets before training. Dataset download links are available in `docs/upstream/arcface.md`.
