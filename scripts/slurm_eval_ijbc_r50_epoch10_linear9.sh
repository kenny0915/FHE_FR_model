...
model_kwargs='{"num_features":512,"herpn_progress":0.0,"herpn_bn_eps":0.0001,"herpn_range_limit":1.0,"prelu_herpn_layerwise_scale":true,"prelu_herpn_initial_scale":1.0,"prelu_herpn_distill_eps":0.0001,"prelu_herpn_legacy_prefix":8,"prelu_herpn_linear_indices":[24]}'
